...
<div class="table-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-warning">Registered Users</h2>
        <!-- 🔙 Back to External Form -->
        <a href="day45_register_form.html" class="btn btn-outline-light">← Back to Form</a>
    </div>
    ...
    <table class="table table-bordered table-dark table-hover">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="day45_edit_register.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary">Edit</a>
