            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="../forms/day45_show_register.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Register</p>
                    </a>
                  </li>
                    <li class="nav-item">
                    <a href="../forms/day45_show_services.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Service</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/day45_show_portfolio.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Portfolio</p>
                    </a>
                  </li>
                   <li class="nav-item">
                    <a href="../forms/day45_show_contacts.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Contacts</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="../forms/day45_show_about.php" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>About</p>
                    </a>
                  </li>
